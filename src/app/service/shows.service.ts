...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Peacemaker', 'network': 'HBOMax', 'link': 'https://www.hbo.com/peacemaker', 'image': 'Peacemaker', 'type': 'png', 'info': 'Thursdays 10:00PM', 'season': 1, 'start': 'January 13, 2022', 'slot': 'SBS' },
  { 'name': 'Perry Mason', 'network': 'HBOMax', 'link': 'https://www.hbo.com/perry-mason', 'image': 'PerryMason', 'type': 'gif', 'info': 'Sundays 10:00PM', 'season': 1, 'start': 'June 21, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'Real Time with Bill Maher', 'network': 'HBOMax', 'link': 'https://www.hbo.com/real-time-with-bill-maher', 'image': 'RealTime', 'type': 'gif', 'info': 'Fridays 10:00PM', 'season': 20, 'start': 'January 21, 2022', 'slot': 'SBS' },
