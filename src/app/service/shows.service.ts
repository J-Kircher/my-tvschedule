...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Jessica Jones', 'network': 'Netflix', 'link': 'http://www.netflix.com/jessicajones', 'image': 'JessicaJones', 'info': 'Streaming', 'start': 'June 14, 2019', 'slot': 'SBS' },
  ...
  { 'name': 'The Mandalorian', 'network': 'Disney+', 'link': 'http://www.disneyplus.com/the-mandalorian/', 'image': 'Mandalorian', 'info': 'Streaming', 'start': 'November 12, 2019', 'slot': 'SBS' },
