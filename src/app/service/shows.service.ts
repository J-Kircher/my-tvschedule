...
const SHOWS: IShow[] = [
  ...
  { 'name': 'It: Welcome to Derry', 'network': 'HBOMax', 'link': 'https://www.hbomax.com/it-welcome-to-derry', 'image': 'WelcomeToDerry', 'type': 'png', 'info': 'Streaming Saturdays', 'season': 1, 'start': 'October 25, 2025', 'slot': 'SBS' },
  ...
  { 'name': 'Solar Opposites', 'network': 'Hulu', 'link': 'http://www.hulu.com/solar-opposites/', 'image': 'SolarOpposites', 'type': 'gif', 'info': 'Streaming', 'season': 6, 'start': 'October 13, 2025', 'slot': 'SBS' },
  ...
  { 'name': 'Survivor', 'network': 'Paramount+', 'link': 'https://www.paramountplus.com/shows/survivor/', 'image': 'Survivor', 'type': 'gif', 'info': 'Wednesdays 8:00PM', 'season': 49, 'start': 'September 24, 2025', 'slot': 'SBS' },
  { 'name': 'Talamasca', 'network': 'AMC+', 'link': 'https://www.amcplus.com/shows/anne-rice-talamasca-the-secret-order--1072344', 'image': 'Talamasca', 'type': 'png', 'info': 'Sundays 10:00PM', 'season': 1, 'start': 'October 26, 2025', 'slot': 'SBS' },
