...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Doctor Who', 'network': 'Max', 'link': 'https://play.max.com/show/b36dc8c3-d424-45eb-8eb0-18c514d566df', 'image': 'DoctorWho11', 'type': 'gif', 'info': 'Sundays 8:00PM', 'season': 13, 'start': 'October 31, 2021', 'slot': 'SBS' },
  { 'name': 'Fallout', 'network': 'Amazon', 'link': 'https://www.amazon.com/dp/B0CN4H1V9D', 'image': 'Fallout', 'type': 'png', 'info': 'Streaming Tuesdays', 'season': 1, 'start': 'April 9, 2024', 'slot': 'SBS' },
  ...
  { 'name': 'House of the Dragon', 'network': 'Max', 'link': 'http://www.max.com/house-of-the-dragon/', 'image': 'HouseOfTheDragon', 'type': 'png', 'info': 'Sundays 9:00PM', 'season': 2, 'start': 'August 18, 2024', 'slot': 'SBS' },
  ...
  { 'name': 'Peacemaker', 'network': 'Max', 'link': 'https://www.max.com/peacemaker', 'image': 'Peacemaker', 'type': 'png', 'info': 'Thursdays 10:00PM', 'season': 1, 'start': 'January 13, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Star Trek: Discovery', 'network': 'Paramount+', 'link': 'https://www.paramountplus.com/shows/star-trek-discovery/', 'image': 'Discovery', 'type': 'png', 'info': 'Streaming', 'season': 5, 'start': 'April 4, 2024', 'slot': 'SBS' },
  ...
  { 'name': 'The Boys', 'network': 'Amazon', 'link': 'https://www.amazon.com/dp/B09WV8HF7Q', 'image': 'TheBoys3', 'type': 'png', 'info': 'Streaming Fridays', 'season': 4, 'start': 'June 13, 2024', 'slot': 'SBS' },
