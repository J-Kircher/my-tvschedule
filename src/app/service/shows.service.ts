...
const SHOWS: IShow[] = [
  { 'name': 'Altered Carbon', 'network': 'Netflix', 'link': 'http://www.netflix.com/alteredcarbon', 'image': 'AlteredCarbon', 'info': 'Streaming', 'start': 'February 27, 2020', 'slot': 'SBS' },
  { 'name': 'American Gods', 'network': 'Starz', 'link': 'http://www.starz.com/americangods/', 'image': 'AmericanGods', 'info': 'Sundays 8:00PM', 'season': 3, 'start': 'January 10, 2021', 'slot': 'SBS' },
  ...
  { 'name': 'Bad Batch', 'network': 'Disney+', 'link': 'https://www.starwars.com/disneyplus', 'image': 'BadBatch', 'info': 'Streaming', 'start': 'January 1, 2017', 'slot': 'SBS' },
  ...
  { 'name': 'Better Call Saul', 'network': 'AMC', 'link': 'http://www.amctv.com/shows/better-call-saul/', 'image': 'BetterCallSaul', 'info': 'Sundays 10:00PM', 'start': 'February 23, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'Castlevania', 'network': 'Netflix', 'link': 'http://www.netflix.com/castlevania', 'image': 'Castlevania', 'info': 'Streaming', 'start': 'March 5, 2020', 'slot': 'SBS' },
  { 'name': 'Chilling Adventures of Sabrina', 'network': 'Netflix', 'link': 'http://www.netflix.com/chillingadventuresofsabrina', 'image': 'Sabrina', 'info': 'Streaming', 'season': 4, 'start': 'December 31, 2020', 'slot': 'SBS' },
  { 'name': 'Cobra Kai', 'network': 'Netflix', 'link': 'http://www.netflix.com/CobraKai', 'image': 'CobraKai', 'info': 'Streaming', 'season': 3, 'start': 'January 8, 2021', 'slot': 'SBS' },
  { 'name': 'Crossing Swords', 'network': 'Hulu', 'link': 'http://www.hulu.com/crossing-swords/', 'image': 'CrossingSwords', 'info': 'Streaming', 'start': 'June 12, 2020', 'slot': 'SBS' },
  { 'name': 'Cursed', 'network': 'Netflix', 'link': 'http://www.netflix.com/cursed', 'image': 'Cursed', 'info': 'Streaming', 'start': 'July 17, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'His Dark Materials', 'network': 'HBO', 'link': 'http://www.hbo.com/his-dark-materials/', 'image': 'HisDarkMaterials', 'info': 'Mondays 9:00PM', 'season': 2, 'start': 'November 16, 2020', 'slot': 'SBS' },
  { 'name': 'Kenobi', 'network': 'Disney+', 'link': 'https://www.starwars.com/disneyplus', 'image': 'Kenobi', 'info': 'Streaming', 'start': 'January 1, 2017', 'slot': 'SBS' },
  { 'name': 'Last Week Tonight', 'network': 'HBO', 'link': 'http://www.hbo.com/last-week-tonight-with-john-oliver/', 'image': 'LastWeekTonight', 'info': 'Sundays 11:00PM', 'season': 7, 'start': 'February 16, 2020', 'slot': 'SBS' },
  { 'name': 'Legends of Tomorrow', 'network': 'CW', 'link': 'http://www.cwtv.com/shows/dcs-legends-of-tomorrow/', 'image': 'LegendsOfTomorrow', 'info': 'Tuesdays 9:00PM', 'start': 'January 14, 2020', 'slot': 'SBS' },
  { 'name': 'Locke and Key', 'network': 'Netflix', 'link': 'http://www.netflix.com/locke&key', 'image': 'LockeAndKey', 'info': 'Streaming', 'start': 'February 7, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'Lovecraft Country', 'network': 'HBO', 'link': 'http://www.hbo.com/lovecraft-country/', 'image': 'LovecraftCountry', 'info': 'Sundays 10:00PM', 'season': 1, 'start': 'August 16, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'Ozark', 'network': 'Netflix', 'link': 'http://www.netflix.com/ozark', 'image': 'Ozark', 'info': 'Streaming', 'start': 'March 27, 2020', 'slot': 'SBS' },
  { 'name': 'Paradise P.D.', 'network': 'Netflix', 'link': 'http://www.netflix.com/paradisepd', 'image': 'ParadisePD', 'info': 'Streaming', 'start': 'March 6, 2020', 'slot': 'SBS' },
  { 'name': 'Penny Dreadful: City of Angels', 'network': 'Showtime', 'link': 'http://www.sho.com/penny-dreadful-city-of-angels', 'image': 'PennyDreadfulCityOfAngels', 'info': 'Sundays 10:00PM', 'start': 'April 26, 2020', 'slot': 'SBS' },
  { 'name': 'Real Housewives of Orange County', 'network': 'Bravo', 'link': 'http://www.bravotv.com/the-real-housewives-of-orange-county', 'image': 'RealHousewivesOrangeCounty', 'info': 'Wednesdays 10:00PM', 'season': 15, 'start': 'October 14, 2020', 'slot': 'SBS' },
  { 'name': 'Perry Mason', 'network': 'HBO', 'link': 'http://www.hbo.com/perry-mason/', 'image': 'PerryMason', 'info': 'Sundays 10:00PM', 'start': 'June 21, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'Real Time with Bill Maher', 'network': 'HBO', 'link': 'http://www.hbo.com/real-time-with-bill-maher/', 'image': 'RealTime', 'info': 'Fridays 10:00PM', 'season': 18, 'start': 'January 17, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'Solar Opposites', 'network': 'Hulu', 'link': 'http://www.hulu.com/solar-opposites/', 'image': 'SolarOpposites', 'info': 'Streaming', 'start': 'May 8, 2020', 'slot': 'SBS' },
  { 'name': 'Space Force', 'network': 'Netflix', 'link': 'http://www.netflix.com/spaceforce', 'image': 'SpaceForce', 'info': 'Streaming', 'start': 'May 29, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'Supernatural', 'network': 'CW', 'link': 'http://www.cwtv.com/shows/supernatural/', 'image': 'Supernatural15', 'info': 'Thursdays 8:00PM', 'season': 15, 'start': 'October 08, 2020', 'slot': 'SBS' },
  { 'name': 'Survivor', 'network': 'CBS', 'link': 'http://www.cbs.com/shows/survivor/', 'image': 'Survivor', 'info': 'Wednesdays 8:00PM', 'start': 'February 12, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'The Expanse', 'network': 'Amazon', 'link': 'https://www.amazon.com/dp/B018BZ3UWU', 'image': 'Expanse', 'info': 'Streaming', 'season': 5, 'start': 'December 16, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'The Order', 'network': 'Netflix', 'link': 'https://www.netflix.com/theorder', 'image': 'TheOrder', 'info': 'Streaming', 'start': 'June 18, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'The Outsider', 'network': 'HBO', 'link': 'http://www.hbo.com/the-outsider/', 'image': 'Outsider', 'info': 'Sundays 9:00PM', 'start': 'January 12, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'The Stranger', 'network': 'Netflix', 'link': 'http://www.netflix.com/thestranger', 'image': 'TheStranger', 'info': 'Streaming', 'start': 'January 30, 2020', 'slot': 'SBS' },
  ...
  { 'name': 'The Witcher', 'network': 'Netflix', 'link': 'http://www.netflix.com/thewitcher', 'image': 'Witcher', 'info': 'Streaming', 'start': 'December 20, 2019', 'slot': 'SBS' },
  ...
  { 'name': 'Truth Seekers', 'network': 'Amazon', 'link': 'https://www.amazon.com/Truth-Seekers-Season-1/dp/B08J18TQ9T', 'image': 'TruthSeekers', 'info': 'Streaming', 'season': 1, 'start': 'October 30, 2020', 'slot': 'SBS' },
  { 'name': 'Westworld', 'network': 'HBO', 'link': 'http://www.hbo.com/westworld/', 'image': 'Westworld', 'info': 'Sundays 9:00PM', 'season': 3, 'start': 'March 15, 2020', 'slot': 'SBS' },
  { 'name': 'What We Do in the Shadows', 'network': 'FX', 'link': 'https://www.fxnetworks.com/shows/what-we-do-in-the-shadows', 'image': 'WhatWeDoInTheShadows', 'info': 'Wednesdays 10:00PM', 'start': 'April 15, 2020', 'slot': 'SBS' },
  { 'name': 'Fugget About It', 'network': 'Hulu', 'link': 'http://www.hulu.com/fugget-about-it/', 'image': 'FuggetAboutIt', 'info': 'Streaming', 'start': 'October 28, 2017', 'slot': 'END' },
  ...
  { 'name': 'Star Wars Resistance', 'network': 'DisneyXD', 'link': 'http://www.starwars.com/tv-shows/star-wars-resistance', 'image': 'Resistance', 'info': 'Sundays 10:00PM', 'start': 'October 6, 2019', 'slot': 'END' },
  { 'name': 'Arrow', 'network': 'CW', 'link': 'http://www.cwtv.com/shows/arrow/', 'image': 'Arrow', 'info': 'Tuesdays 9:00PM', 'start': 'October 15, 2019', 'slot': 'END' },
  { 'name': 'Watchmen', 'network': 'HBO', 'link': 'http://www.hbo.com/watchmen/', 'image': 'Watchmen', 'info': 'Sundays 9:00PM', 'start': 'October 20, 2019', 'slot': 'END' },
  { 'name': 'Criminal Minds', 'network': 'CBS', 'link': 'http://www.cbs.com/shows/criminal_minds/', 'image': 'CriminalMinds', 'info': 'Wednesdays 10:00PM', 'start': 'January 8, 2020', 'slot': 'END' },
  { 'name': 'Vikings', 'network': 'History', 'link': 'http://www.history.com/shows/vikings', 'image': 'Vikings', 'info': 'Wednesdays 9:00PM', 'start': 'December 4, 2019', 'slot': 'END' },
  { 'name': 'Homeland', 'network': 'Showtime', 'link': 'http://www.sho.com/homeland', 'image': 'Homeland', 'info': 'Sundays 9:00PM', 'start': 'February 9, 2020', 'slot': 'END' },
  { 'name': 'Dark Crystal: Age of Resistance', 'network': 'Netflix', 'link': 'http://www.netflix.com/title/80148535', 'image': 'DarkCrystalAge', 'info': 'Streaming', 'start': 'August 30, 2019', 'slot': 'END' }
];
