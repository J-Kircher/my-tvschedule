...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Bad Batch', 'network': 'Disney+', 'link': 'https://www.disneyplus.com/series/the-bad-batch/4gMliqFxxqXC', 'image': 'BadBatch', 'type': 'png', 'info': 'Streaming Wednesdays', 'season': 3, 'start': 'February 21, 2024', 'slot': 'SBS' },
  ...
  { 'name': 'Doctor Who', 'network': 'Max', 'link': 'https://play.max.com/page/urn:hbo:page:GXnzXWA8PcFSpjQEAAATH:type:series', 'image': 'DoctorWho11', 'type': 'gif', 'info': 'Sundays 8:00PM', 'season': 13, 'start': 'October 31, 2021', 'slot': 'SBS' },
  ...
  { 'name': 'House of the Dragon', 'network': 'Max', 'link': 'http://www.max.com/house-of-the-dragon/', 'image': 'HouseOfTheDragon', 'type': 'png', 'info': 'Sundays 9:00PM', 'season': 1, 'start': 'August 21, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Last Week Tonight', 'network': 'Max', 'link': 'https://www.max.com/last-week-tonight-with-john-oliver', 'image': 'LastWeekTonight', 'type': 'gif', 'info': 'Sundays 11:00PM', 'season': 10, 'start': 'February 19, 2023', 'slot': 'SBS' },
  ...
  { 'name': 'Peacemaker', 'network': 'Max', 'link': 'https://play.max.com/page/urn:hbo:page:home', 'image': 'Peacemaker', 'type': 'png', 'info': 'Thursdays 10:00PM', 'season': 1, 'start': 'January 13, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Saturday Night Live', 'network': 'NBC', 'link': 'http://www.nbc.com/saturday-night-live/', 'image': 'SaturdayNightLive48', 'type': 'png', 'info': 'Saturdays 11:30PM', 'season': 49, 'start': 'October 14, 2023', 'slot': 'SBS' },
  ...
  { 'name': 'The Last of Us', 'network': 'Max', 'link': 'http://www.max.com/the-last-of-us/', 'image': 'LastOfUs', 'type': 'png', 'info': 'Sundays 10:00PM', 'season': 1, 'start': 'January 15, 2023', 'slot': 'SBS' },
  ...
  { 'name': 'The Old Man', 'network': 'FX', 'link': 'http://www.fxnetworks.com/shows/the-old-man/', 'image': 'TheOldMan', 'type': 'png', 'info': 'Thursdays 10:00PM', 'season': 1, 'start': 'June 16, 2022', 'slot': 'SBS' },
  { 'name': 'The Rings of Power', 'network': 'Amazon', 'link': 'https://www.amazon.com/dp/B09QHCPD34', 'image': 'RingsOfPower', 'type': 'png', 'info': 'Streaming Thursdays', 'season': 1, 'start': 'September 1, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Lovecraft Country', 'network': 'Max', 'link': 'https://www.max.com/lovecraft-country', 'image': 'LovecraftCountry', 'type': 'gif', 'info': 'Sundays 10:00PM', 'season': 1, 'start': 'August 16, 2020', 'slot': 'END' },
  ...
  { 'name': 'His Dark Materials', 'network': 'Max', 'link': 'https://www.max.com/his-dark-materials', 'image': 'HisDarkMaterials', 'type': 'gif', 'info': 'Mondays 9:00PM', 'season': 3, 'start': 'December 5, 2022', 'slot': 'END' },
  ...
  { 'name': 'Perry Mason', 'network': 'Max', 'link': 'https://www.max.com/perry-mason', 'image': 'PerryMason', 'type': 'gif', 'info': 'Sundays 10:00PM', 'season': 2, 'start': 'March 6, 2023', 'slot': 'END' },
