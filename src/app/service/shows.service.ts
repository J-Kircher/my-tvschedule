...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Locke and Key', 'network': 'Netflix', 'link': 'http://www.netflix.com/locke&key', 'image': 'LockeAndKey', 'type': 'gif', 'info': 'Streaming', 'season': 3, 'start': 'August 10, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Rick and Morty', 'network': 'AS', 'link': 'http://www.adultswim.com/RickAndMorty', 'image': 'RickAndMorty', 'type': 'gif', 'info': 'Sundays', 'season': 6, 'start': 'September 4, 2022', 'slot': 'SBS' },
