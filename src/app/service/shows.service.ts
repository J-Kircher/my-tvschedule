...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Better Call Saul', 'network': 'AMC', 'link': 'http://www.amctv.com/shows/better-call-saul/', 'image': 'BetterCallSaul', 'type': 'gif', 'info': 'Sundays 10:00PM', 'season': 6, 'start': 'April 18, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Kenobi', 'network': 'Disney+', 'link': 'https://disneyplusoriginals.disney.com/show/obi-wan-kenobi', 'image': 'Kenobi', 'type': 'gif', 'info': 'Streaming', 'season': 1, 'start': 'May 25, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Severence', 'network': 'Starz', 'link': 'https://tv.apple.com/us/show/severance/umc.cmc.1srk2goyh2q2zdxcx605w8vtx', 'image': 'Severance', 'type': 'png', 'info': 'Streaming', 'season': 1, 'start': 'February 18, 2022', 'slot': 'SBS' },
  { 'name': 'Shining Vale', 'network': 'Starz', 'link': 'https://www.starz.com/us/en/series/shining-vale/64078', 'image': 'ShiningVale', 'type': 'png', 'info': 'Sundays 8:00PM', 'season': 1, 'start': 'March 6, 2022', 'slot': 'SBS' },
