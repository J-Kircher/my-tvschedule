...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Carnival Row', 'network': 'Amazon', 'link': 'https://www.amazon.com/dp/B0B65WKLPS', 'image': 'CarnivalRow', 'type': 'gif', 'info': 'Streaming', 'season': 2, 'start': 'February 17, 2023', 'slot': 'SBS' },
  ...
  { 'name': 'Kenobi', 'network': 'Disney+', 'link': 'https://www.disneyplus.com/series/obi-wan-kenobi/2JYKcHv9fRJb', 'image': 'Kenobi', 'type': 'gif', 'info': 'Streaming Wednesdays', 'season': 1, 'start': 'May 27, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Moon Knight', 'network': 'Disney+', 'link': 'https://www.disneyplus.com/series/moon-knight/4S3oOF1knocS', 'image': 'MoonKnight', 'type': 'png', 'info': 'Streaming', 'season': 1, 'start': 'March 30, 2022', 'slot': 'SBS' },
  ...
  { 'name': 'Star Trek: Picard', 'network': 'Paramount+', 'link': 'https://www.paramountplus.com/shows/star-trek-picard/', 'image': 'Picard2', 'type': 'png', 'info': 'Streaming', 'season': 3, 'start': 'February 16, 2023', 'slot': 'SBS' },
  ...
  { 'name': 'The Mandalorian', 'network': 'Disney+', 'link': 'https://www.disneyplus.com/series/the-mandalorian/3jLIGMDYINqD', 'image': 'Mandalorian', 'type': 'gif', 'info': 'Streaming', 'season': 3, 'start': 'March 1, 2023', 'slot': 'SBS' },
  ...
  { 'name': 'Willow', 'network': 'Disney+', 'link': 'https://www.disneyplus.com/series/willow/PfeL8yCNXD3r', 'image': 'Willow', 'type': 'png', 'info': 'Streaming', 'season': 1, 'start': 'November 30, 2022', 'slot': 'SBS' },
