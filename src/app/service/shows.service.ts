...
const SHOWS: IShow[] = [
  ...
  { 'name': 'Criminal Minds - Evolution', 'network': 'Paramount+', 'link': 'https://www.paramountplus.com/shows/criminal_minds/', 'image': 'CriminalMindsEvolution', 'type': 'png', 'info': 'Thursdays 10:00PM', 'season': 4, 'start': 'May 28, 2026', 'slot': 'SBS' },
  { 'name': 'Daredevil: Born Again', 'network': 'Disney+', 'link': 'https://ondisneyplus.disney.com/show/daredevil-born-again', 'image': 'DaredevilBornAgain', 'type': 'png', 'info': 'Streaming Tuesdays', 'season': 2, 'start': 'March 24, 2026', 'slot': 'SBS' },
  ...
  { 'name': 'House of the Dragon', 'network': 'HBOMax', 'link': 'http://www.hbomax.com/house-of-the-dragon/', 'image': 'HouseOfTheDragon', 'type': 'png', 'info': 'Sundays 9:00PM', 'season': 3, 'start': 'June 21, 2026', 'slot': 'SBS' },
  { 'name': 'The Vampire Chronicles: The Vampire Lestat', 'network': 'AMC+', 'link': 'https://www.amcplus.com/shows/interview-with-the-vampire--1053259', 'image': 'TheVampireLestat2', 'type': 'png', 'info': 'Sundays 10:00PM', 'season': 3, 'start': 'June 7, 2026', 'slot': 'SBS' },
  ...
  { 'name': 'Lanterns', 'network': 'HBOMax', 'link': 'https://www.hbomax.com/lanterns', 'image': 'Lanterns', 'type': 'png', 'info': 'Sundays 10:00PM', 'season': 1, 'start': 'August 16, 2026', 'slot': 'SBS' },
  { 'name': 'Last Week Tonight', 'network': 'Max', 'link': 'https://play.max.com/topical/f7ebcd02-6641-4ec5-a392-07e58196808f', 'image': 'LastWeekTonight', 'type': 'gif', 'info': 'Sundays 11:00PM', 'season': 13, 'start': 'February 15, 2026', 'slot': 'SBS' },
  { 'name': 'Maul', 'network': 'Disney+', 'link': 'https://www.disneyplus.com/browse/entity-9ba0f41b-6173-4ff1-8967-71cad0620244', 'image': 'Maul', 'type': 'png', 'info': 'Streaming Mondays', 'season': 1, 'start': 'April 6, 2026', 'slot': 'SBS' },
  ...
  { 'name': 'Rick and Morty', 'network': 'AS', 'link': 'https://www.wco.tv/anime/rick-and-morty', 'image': 'RickAndMorty', 'type': 'gif', 'info': 'Sundays 11:00PM', 'season': 9, 'start': 'May 24, 2026', 'slot': 'SBS' },
  { 'name': 'Saturday Night Live', 'network': 'NBC', 'link': 'http://www.nbc.com/saturday-night-live/', 'image': 'SaturdayNightLive51', 'type': 'png', 'info': 'Saturdays 11:30PM', 'season': 51, 'start': 'October 4, 2025', 'slot': 'SBS' },
  ...
  { 'name': 'Star Trek: Strange New Worlds', 'network': 'Paramount+', 'link': 'https://www.paramountplus.com/shows/star-trek-strange-new-worlds/', 'image': 'StrangeNewWorlds', 'type': 'png', 'info': 'Streaming Thursdays', 'season': 5, 'start': 'July 23, 2026', 'slot': 'SBS' },
  ...
  { 'name': 'The Old Man', 'network': 'FX', 'link': 'http://www.fxnetworks.com/shows/the-old-man/', 'image': 'TheOldMan', 'type': 'png', 'info': 'Thursdays 10:00PM', 'season': 2, 'start': 'Sepetember 12, 2024', 'slot': 'END' },
